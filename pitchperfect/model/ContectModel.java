...
import pitchperfect.bean.ContectBean;
...
public class ContectModel {
	...
	public Integer nextPK() throws DatabaseException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement("SELECT MAX(ID) FROM Contact");
	...
	public ContectBean findByPK(long pk) throws ApplicationException {
		...
		StringBuffer sql = new StringBuffer("SELECT * FROM Contact WHERE ID=?");
	...
	public long add(ContectBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement("INSERT INTO Contact VALUES(?,?,?,?,?,?,?,?)");
			pstmt.setInt(1, pk);
	...
	public void delete(ContectBean bean) throws ApplicationException {
        ...
        try {
          ...
          //  log.error("Database Exception..", e);
            ...
            throw new ApplicationException(
                    "Exception : Exception in delete Contact");
        } finally {
            JDBCDataSource.closeConnection(conn);
        }
        log.debug("Model delete Started");
